...
xterm -bg black -fg red -geometry 100x30-0+150 -title "TSharK" -e tshark -i $INTERFAZ_MONITOR subtype probereq -l -Tfields -e frame.time -e wlan.sa -e wlan.da -e radiotap.dbm_antsignal -e wlan_mgt.ssid > /dev/null &
